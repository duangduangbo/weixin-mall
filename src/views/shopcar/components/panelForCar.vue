<template>
    <div class="panel-car c-line">
        ...
        <div @click="clickToDetails"  style="display:inline-block;">
            <x-img :src="carList.picurl" :default-src="picurl"
...
<script>
// 购物车图文
import { Flexbox, FlexboxItem,Group,XNumber,InlineXNumber,CheckIcon,XImg } from 'vux'
