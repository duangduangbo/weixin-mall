    ...
    <div class="center-top">
        ...
        <flexbox orient="vertical" :gutter="0">
            <flexbox-item>
                ...
                <x-img :src="img_url" :default-src="picurl"
                    class="head-img" ></x-img>
                </div>
            </flexbox-item>
            <flexbox-item  class="c-center">
                <div class="c-padding">
                    <span class="c-center-name"> {{ username }} </span>
                </div>
            </flexbox-item>
            <!-- <flexbox-item  class="c-center">
...
<script>
import { Flexbox, FlexboxItem,TransferDom,XButton,Popup,XImg } from 'vux'
import { mapActions } from 'vuex';
import { setToken, getToken,
setDistributorId,getInvitation,
setInvitation,getCode,setCode,setInvitationCode } from '@/libs/util'
