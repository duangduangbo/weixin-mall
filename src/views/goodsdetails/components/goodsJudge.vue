<template>
    <div class="goods-judge">
        <flexbox  orient="vertical" :gutter="0" class="c-goods-flexbox">
            <flexbox-item class="c-left c-flex-one">
            ...
            <flexbox-item class="c-left c-flex-three">
                <!-- <div class="c-show" v-for="k in imgList">
                    <div class="c-show-img" :style="{backgroundImage:'url('+k+')'}"></div>
                </div> -->
            </flexbox-item>
        </flexbox>
    </div>
...
let baseList=[require("@_a/images/banner.png"),require("@_a/images/banner.png"),require("@_a/images/banner.png")];
export default {
    name:"goodsJudge",
    components:{
        Flexbox, 
    ...
    props:{
        img_url:{
            default:require("@_a/images/banner.png")
        },
        imgList:{
            default:()=>baseList
        },
