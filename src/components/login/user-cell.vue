<template>
    <div class="invitation-cell">
      ...
      <div class='cell-no-invitation' v-show="isInvitation"><a @click="clickToHome">无邀请码，绑定就近商家，直接进入</a></div>
    </div>
</template>
...
export default {
  ...
  methods: {
    ...mapActions(["getinvitation", "handleIsNotInvitation"]),
    getInvitation() {
